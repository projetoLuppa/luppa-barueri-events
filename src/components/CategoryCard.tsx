...
const CategoryCard = ({ icon: Icon, title, count, gradient }: CategoryCardProps) => {
  return (
    <Card className={`${gradient} p-6 hover-lift cursor-pointer shadow-card hover:shadow-hover transition-all duration-300 group`}>
